...
## Corpus Check
- 143 files · ~468,909 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1053 nodes · 1432 edges · 31 communities detected
...
Cohesion: 0.02
Nodes (121): getPendingSyncOpsSync, IsarLocalCache, _pickCotisation, _pickCulte, _pickMembre, getPendingSyncOpsSync, LocalCache, resetLastSyncAt (+113 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (89): _notificationIdFor, NotificationService, _asList, _asSingle, InsForgeService, StateError, calculerMontantDu, calculerNombreRetards (+81 more)
...
Cohesion: 0.03
Nodes (84): ThemeModeNotifier, build, initState, _isRegistered, _maybeShowDialog, OneSignalVerificationGate, _OneSignalVerificationGateState, _setupSubscriptionObserver (+76 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (80): build, _confirmDelete, EmptyState, Icon, initState, _loadRetards, MembresScreen, _MembresScreenState (+72 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (75): AppPrefs, AppPrefsKey, _check, AlertDialog, build, _buildStatCard, FlDotCirclePainter, FlLine (+67 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (37): addNotificationClickListener, addPushSubscriptionObserver, OneSignalService, setLogLevel, _BouncingScrollBehavior, BouncingScrollPhysics, build, Duration (+29 more)
...
Cohesion: 0.08
Nodes (24): build, _Card, Container, dispose, GestureDetector, initState, Padding, ProfileScreen (+16 more)
...
Cohesion: 0.14
Nodes (13): build, _CadenceCard, Container, _HistoriqueItem, MembreDetailScreen, Padding, paint, _ProgressPainter (+5 more)
...
## Knowledge Gaps
- **789 isolated node(s):** `Intercept NOTIFY_DEBUGGER_ABOUT_RX_PAGES and touch the pages.`, `-registerWithRegistry`, `KasedApp`, `_BouncingScrollBehavior`, `runZonedGuarded` (+784 more)
...
- **Why does `package:flutter/material.dart` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.335) - this node is a cross-community bridge._
- **Why does `package:flutter_riverpod/flutter_riverpod.dart` connect `Community 3` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 11`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `package:kased_app/providers/app_data_provider.dart` connect `Community 0` to `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 20`, `Community 21`?**
