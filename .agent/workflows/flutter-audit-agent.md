---
description: Agent IA de niveau Principal-Ingénieur pour l'audit exhaustif d'applications Flutter en vue d'une mise en production grand public avec un objectif de fiabilité à 99% IC (Intervalle de Confiance).
---
