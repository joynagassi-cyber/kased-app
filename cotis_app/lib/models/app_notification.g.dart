...
extension AppNotificationByIndex on IsarCollection<AppNotification> {
  Future<AppNotification?> getById(String id) {
    return getByIndex(r'id', [id]);
  }

  AppNotification? getByIdSync(String id) {
  ...
  Future<List<AppNotification?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<AppNotification?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(AppNotification object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(AppNotification object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<AppNotification> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<AppNotification> objects,
      {bool saveLinks = true}) {
